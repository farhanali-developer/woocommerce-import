...
foreach($csv_file as $csv_data){
    ...
    if (!empty($csv_file_data)):
        ...
        foreach ($csv_file_data as $product){
            ...
            if (!$product_id){
                // echo "New Product ID is: $product_id \n";
                try {
            ...
            //product found
                ...
                try {
                    ...
                    if ( $update_product instanceof WC_Product) {
                        ...
                        if($product[$data['Type']] != "variation"){
                            if(!empty($product[$data['Name']])){
                        ...
                        // else if($product[$data['Type']] == "variation"){
                        else if($product[$data['Type']] === "variation" || $product[$data['Type']] === "variation, downloadable, virtual" || $product[$data['Type']] === "variation, downloadable" || $product[$data['Type']] === "variation, virtual"){
                            $variation = new WC_Product_Variation();
                            $variation->set_parent_id( $products->get_id() );
                        ...
                        // $pusher->trigger('my-channel', 'my-event', $data);
                        // echo "".$update_product->get_name()." Updated.";
                        // print("<pre>".print_r($update_product,true)."</pre>");
                        $data['message'] = "".$update_product->get_name()." Updated.";
                        $row_updated++;
                        $data['row_updated'] = $row_updated;
                        $new_products++;
        ...
        $result += ["time_taken" => $time_elapsed_secs];
